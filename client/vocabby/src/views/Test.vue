...
export default {
  ...
  methods: {
    ...
    clickAnswer(wordId) {
      ...
      axios
          .put('https://127.0.0.1:3069/api/vocably/answer/' + this.question.questionId, {wordId: wordId})
          .then(res => {
    ...
    async disableQuestion() {
      ...
      try {
        var res = await axios.delete('https://127.0.0.1:3069/api/vocably/question/' + this.question.questionId)
